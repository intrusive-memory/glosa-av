...
struct StageDirectorAnnotateTests {
    ...
    func neutralGapBetweenIntents() async throws {
        ...
        #expect(dialogueAnnotations[0].instruct != nil, "Line 0 should have instruct (covered by intent)")
        #expect(dialogueAnnotations[1].instruct != nil, "Line 1 should have instruct (covered by intent)")
...
struct StageDirectorMappingTests {
    ...
    func lineRangeMapsToCorrectElements() async throws {
        ...
        #expect(line0.directives?.intent?.arcPosition == 0.0,
                "First dialogue line should have arc position 0.0")
        #expect(line1.directives?.intent?.arcPosition == 0.5,
                "Second dialogue line should have arc position 0.5")
        #expect(line2.directives?.intent?.arcPosition == 1.0,
...
struct StageDirectorValidationTests {
    ...
    func malformedAnnotationEndToEnd() async throws {
        ...
        let malformedAnnotation = SceneAnnotation(
            ...
            constraints: [
                ConstraintAnnotation(character: "ALICE", direction: "quiet and reserved", ceiling: "subdued"),
            ]
        )
...
struct PromptsTests {
    ...
    func systemPromptContainsScopeRules() {
        ...
        #expect(prompt.contains("do NOT nest"), "System prompt should mention Intent nesting prohibition")
    }
    ...
    func systemPromptWithGlossary() throws {
        ...
        #expect(prompt.contains("Preferred Vocabulary"), "Prompt should contain vocabulary section header")
    ...
    func systemPromptWithoutGlossary() {
        ...
        #expect(!prompt.contains("Preferred Vocabulary"),
