...
struct CompareTests {
  ...
  func diffCoversAllLinesIncludingGaps() async throws {
    ...
    let fullCoverageAnnotation = SceneAnnotation(
      ...
      intents: [
        IntentAnnotation(
          from: "calm", to: "tense", pace: "moderate",
