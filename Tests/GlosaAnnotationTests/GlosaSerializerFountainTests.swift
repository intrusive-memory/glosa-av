...
struct GlosaSerializerFountainTests {
    ...
    func fountainRoundTrip() throws {
        ...
        #expect(compilationResult.instructs.count == reparsedResult.instructs.count,
        ...
        for (key, originalInstruct) in compilationResult.instructs {
            ...
            #expect(originalInstruct == reparsedInstruct,
    ...
    func serializedFountainIsValid() throws {
        ...
        #expect(cleanDialogue.count == originalDialogue.count,
